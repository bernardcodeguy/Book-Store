...
<main>
   ...
   <div class=" container" style="height: 100vh; background-color: #FF5C00;">    
    ...
    <div class="container">  
        <h4 class="white-text" style="padding-top: 30px; font-size: 1.5em;">All Books</h4>                
       
        
            
            <% if(list.isEmpty()){ %>
            
                 <h4 class="white-text center-align" style="padding-top: 330px; font-size: 2.5em;">Books Out of Stock!</h4>
